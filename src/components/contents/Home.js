                ...
                <div className='mt-4 d-flex'>
                    <div className='col-6 d-flex flex-wrap'>
                        ...
                        <div className='w-50 position-relative img_mask' onClick={()=>navigate('/test')}>
                            <p className='img_text top-50 start-50 translate-middle fw-bold' >Babies</p>
                        ...
                        <div className='w-50 position-relative img_mask'>
                            <p className='img_text top-50 start-50 translate-middle fw-bold'>Women</p>
                        ...
                        <div className='w-100 position-relative img_mask'>
                            <p className='img_text top-50 start-50 translate-middle fw-bold'>Men</p>
